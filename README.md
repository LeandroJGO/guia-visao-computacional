...
**Fontes selecionadas no NotebookLM:**

1. **Livro:** Introdução à Visão Computacional com Python e OpenCV.
2. **Videoaula:** Visão Computacional — Introdução à Visão Computacional.
3. **Documento PDF:** `AS_97487_TG_611I26_KA_US_1088_1.pdf` — Keyence Guide.

**Objetivo:** compreender a definição de visão computacional e sua diferença em relação ao processamento de imagens.
...
**Critério de avaliação:** distinções claras e referências que sustentem as explicações.
